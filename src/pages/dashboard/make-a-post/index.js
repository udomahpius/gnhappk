    ...
    <>
      <Layout user={user}>
        ...
        { user.status === "activated" && <section className="inbox-wrapper overflow-hidden h-full bg-gray-200 dark:bg-slate-600 side-body">
          <div className="pt-3 messages overflow-y-auto bg-white dark:bg-slate-900 messages h-full shadow-lg">
          ...
          <aside className="side-profile overflow-y-auto bg-white dark:bg-slate-900 shadow-lg">
            ...
            <div className="pb-12 pt-2">
              ...
              <div className="flex gap-2 items-start justify-between mb-6 py-4 shadow-lg rounded-md px-2 w-full cursor-pointer">
