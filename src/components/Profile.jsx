import { CheckCircleIcon, AtSymbolIcon, UserCircleIcon, OfficeBuildingIcon, BriefcaseIcon } from "@heroicons/react/outline";
...
function Profile() {
    ...
    useEffect(() => {
        setUser(JSON.parse(localStorage.getItem("setly_user")))
    }, [])
            ...
            <div className="grid grid-cols-6 h-full gap-4">
                <div className="col-span-4 h-full">
                    <div className="rounded-lg bg-white py-5 shadow border border-gray-200 mb-5">
                        <h4 className="border-b pb-3 px-6 mb-6">Personal Information</h4>
                        <form className="px-6">
                            <div className=" mb-5">
                            ...
                            <div>
                                <label className="mb-2 flex">Email Address</label>
                ...
                <div className="col-span-2">
                    <div className="bg-white shadow-lg rounded-lg py-5 mb-8 border border-gray-200">
                        ...
                        <div className="px-5 mb-7 flex gap-4 items-center hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                            <Image className="rounded-full h-14 w-14" src={user?.picture === "" ? `https://ui-avatars.com/api/?name=${user?.first_name}+${user?.last_name}` : user?.picture}
                                width={85} height={85} alt={`${user?.first_name} ${user?.last_name} image`} />
