        ...
        <div className="h-full border flex flex-col justify-center items-center">
            <form>
                <select className="mb-6 py-3 bg-white h-full hover:border-setly-100 hover:border-2 rounded-lg flex px-2 border border-gray w-full outline-none text-gray-400">
                    ...
                    <option>Custom Mode</option>
                    <option>General Mode</option>
                    <option>Pitch Mode</option>
                ...
                <div>
                    <h3 className="font-semibold mb-4">Conversation Starter</h3>

                    <div>
                        <label className="flex text-gray-400 text-sm">Write your reason for connection request</label>
